<script context="module" lang="ts">
    ...
    export const load: Load = async ({ fetch }) => {
        ...
        let cantSolicitudesSinResponderEncuesta: 0;
        let mensajeResponderEncuesta: "";
        ...
        if (ds != null || ds != undefined) {
            ...
            if (errors.length > 0) {
                ...
                if (!res.isSuccess) {
                    ...
                    cantSolicitudesSinResponderEncuesta = res.data['cantSolicitudesSinResponderEncuesta'];
                    mensajeResponderEncuesta = res.data['mensajeResponderEncuesta'];
                }
            }
        }
        ...
        return {
            props: {
                eBalconyRequests,
                cantSolicitudesSinResponderEncuesta,
...
<script lang="ts">
    ...
    export let cantSolicitudesSinResponderEncuesta;
    export let mensajeResponderEncuesta;
    ...
    onMount(async () => {
        debugger;
        console.log(cantSolicitudesSinResponderEncuesta)
        if (cantSolicitudesSinResponderEncuesta > 0) {
            addNotification({
                msg: `${mensajeResponderEncuesta}`,
                type: 'warning',
        ...
        <table class="table mb-0 table-hover">
            <thead class="table-transform">
                <tr>
                    ...
                    <th scope="col" class="border-top-0 text-center align-middle text-capitalize" style="text-align: center;width: 15rem;">Proceso</th>
                    <th scope="col" class="border-top-0 text-center align-middle text-capitalize" style="text-align: center;width: 40rem;">Motivo</th>
                    <th scope="col" class="border-top-0 text-center align-middle text-capitalize d-sm-none d-sm-table-cell d-md-table-cell extra-header" style="text-align: center;width: 5rem;">Evidencias</th>
            ...
            <tbody class="table-light">
                {#each eBalconyRequests as eRequest, index}
                    <tr>
                        ...
                        <td class="fs-6 text-wrap p-0 m-0 align-middle text-capitalize">{eRequest.nombre_servicio_minus}</td>
                        <td class="fs-6 text-wrap p-0 m-0 align-middle">{eRequest.descripcion}</td>
                        ...
                        <td  class="fs-6 p-0 m-0 align-middle" style="text-align: center;">
                            {#if eRequest.estado == 1}
                                <span class="badge" style="background-color: #12216A;">{eRequest.estado_display}</span>
                            {:else if eRequest.estado == 2}
                                <span class="badge" style="background-color: #E93939;">{eRequest.estado_display}</span>
                            {:else if eRequest.estado == 3}
                                <span class="badge" style="background-color: #FF9900;">{eRequest.estado_display}</span>
                            {:else if eRequest.estado == 4}
                                <span class="badge" style="background-color: #209884;">{eRequest.estado_display}</span>
                            {:else if eRequest.estado == 5}
                                <span class="badge" style="background-color: #0dcaf0;">{eRequest.estado_display}</span>
                            {:else if eRequest.estado == 6}
                                <span class="badge" style="background-color: #9E68DC;">{eRequest.estado_display}</span>
                            {:else if eRequest.estado == 7}
                                <span class="badge" style="background-color: #0dcaf0;">{eRequest.estado_display}</span>
                            {:else}
                                <span class="badge" style="background-color: #5d6cb4;">{eRequest.estado_display}</span>
                            {/if}
                        </td>
                        <td class="fs-6 p-0 m-0 align-middle" style="text-align: center;">
                                {#if eRequest.estado !== 1}
